...
//comple command: g++ -std=c++11 -o tag408 -O3 MCMDSpinTagQTSimLinear408.cpp -lm -I/home/tkl1/usr/include -L/users/tkl1/user/lib64
...
char saveDirectory[256] = "data408/";//main directory.  A subfolder titled  Gamma_Kappa_Number___ will be created.  Subsubfolders for each job will be created.  data will be stored in the job folders;
...
//pumping parameters (omega, detuning, tpump)
...
//waveFunctions
cx_mat wvFns[N+1000];//ion wavefunctions
double numStates = 7;
